	...
	return (
		<>
			...
			<main className="min-h-screen p-20 flex justify-center items-center">
				<section className="card max-w-150 md:w-150 mt-2 p-20 rounded-lg shadow-md hover:shadow-lg">
					{/* Formulário do login */}
					<form onSubmit={(e) => login(e)} className="flex flex-col space-y-5">
						{/* Título do card */}
						...
						<button type="submit" className="w-30 h-10 bg-[#2527A7] text-white mt-5 m-auto rounded-md hover:shadow-md cursor-pointer">Log In</button>
					</form>
				</section>
			</main>
		</>
